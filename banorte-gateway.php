...
function banorte_enqueue_checkout_script() {
    if (is_checkout()) {
        wp_enqueue_script('banorte-checkout', plugin_dir_url(__FILE__) . 'assets/js/checkoutV2.js', ['jquery'], '1.0', true);
    }
}
add_action('wp_enqueue_scripts', 'banorte_enqueue_checkout_script');
